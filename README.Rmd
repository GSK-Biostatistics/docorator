...
knitr::include_graphics("man/figures/doc_example.png")
```


# Note

{docorator} requires the following system dependencies for PDF rendering:
- LaTeX libraries for traditional PDF rendering. If using {tinytex}, the "TinyTeX" bundle covers the core dependencies. 
- Chrome/Chromium installation for HTML-based PDF rendering via the {chromote} package (experimental). 
