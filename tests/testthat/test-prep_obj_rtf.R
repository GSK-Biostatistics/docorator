test_that("prep_obj_rtf - ggplot", {
  ...
  docorator <- as_docorator(
    ...
    header = fancyhead(
      fancyrow(center = "this is the title"),
  ...
  expect_equal(
    unlist(gt_1$`_footnotes`$footnotes),
    c("footnote1", "this is the docorator footnote")
  )
  expect_equal(
    unlist(gt_2$`_footnotes`$footnotes),
    c("footnote2", "this is the docorator footnote")
  )
  ...
  expect_equal(
    as.character(gt_1$`_heading`$subtitle),
    "this is the subtitle1<br>this is the subtitle2<br>title1<br>subtitle1<br>tag1"
  )
  expect_equal(gt_2$`_heading`$title, "this is the title")
  expect_equal(
    as.character(gt_2$`_heading`$subtitle),
    "this is the subtitle1<br>this is the subtitle2<br>title2<br>subtitle2<br>tag2"
  )
})

test_that("prep_obj_rtf - png", {
  png_obj1 <- png_path(
    path = system.file("extdata/test_image.png", package = "docorator")
  )
  png_obj2 <- png_path(
    path = system.file("extdata/test_image.png", package = "docorator")
  )
  ...
  expect_equal(
    unlist(gt_1$`_footnotes`$footnotes),
    "this is the docorator footnote"
  )
  expect_equal(
    unlist(gt_2$`_footnotes`$footnotes),
    "this is the docorator footnote"
  ...
  expect_equal(
    as.character(gt_1$`_heading`$subtitle),
    "this is the subtitle1<br>this is the subtitle2"
  )
  expect_equal(gt_2$`_heading`$title, "this is the title")
  expect_equal(
    as.character(gt_2$`_heading`$subtitle),
...
test_that("prep_obj_rtf - character", {
  ...
  expect_equal(
    unlist(gt_display$`_footnotes`$footnotes),
    "this is the docorator footnote"
  )
  ...
  expect_equal(
    as.character(gt_display$`_heading`$subtitle),
    "this is the subtitle1<br>this is the subtitle2"
  )
})
...
test_that("prep_obj_rtf - invalid", {
  ...
  expect_error(
    prep_obj_rtf(docorator),
    "For RTF render the display must be class character, gt_tbl, gt_group, PNG, or ggplot, not a number."
  )
})
